    ...
    return (
        <footer>
            <div>
                ...
                <img src="src/assets/images/governo.png" alt="" />
            </div>

            <div>
                <p>Número de acessos neste site: <b>5450</b></p>
                <p>Desenvolvido pelo Grupo de Pesquisa em Mineração da Dados e Imagens (MiDI) - IFTM - <b>Versão 2.8 (03/03/2025)</b>
                </p>
            </div>
        </footer>
    );
